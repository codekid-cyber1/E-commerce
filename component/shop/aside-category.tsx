...
const Category = () => {
  ...
  return (
    <div className="left-side flex flex-col sm:w-1/3 md:w-1/4 lg:w-1/5 gap-6">
          <div onClick={() => setIsOpen(!isOpen)} className="cursor-pointer menu flex items-center gap-2 text-[var(--foreground)]">
          ...
          {isOpen && (
            <div className="outline-none sm:hidden">
          <div className=" py-4">
          ...
          <div className="outline-none hidden sm:block">
          <div className=" py-4">
            <h3 className="text-lg text-[var(--muted)] font-bold">Category</h3>
            <div className="flex flex-col gap-2 pt-4">
              <div className="flex items-center">
